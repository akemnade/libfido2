...
/* bluetooth */
bool fido_is_bluetooth(const char *);
int fido_dev_set_bluetooth(fido_dev_t *);
void *fido_bluetooth_open(const char *);
void  fido_bluetooth_close(void *);
int fido_bluetooth_read(void *, unsigned char *, size_t, int);
int fido_bluetooth_write(void *, const unsigned char *, size_t);
int fido_bluetooth_rx(fido_dev_t *, uint8_t, unsigned char *, size_t, int);
int fido_bluetooth_tx(fido_dev_t *, uint8_t, const unsigned char *, size_t);
size_t fido_bluetooth_get_cp_size(fido_dev_t *d);
...
int fido_bluetooth_manifest(fido_dev_info_t *, size_t, size_t *);
...
#define FIDO_BLUETOOTH_PREFIX	"bluetooth:"
